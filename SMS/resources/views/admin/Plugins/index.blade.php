                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <p class="item-description">
                                uWhiteLabel is build for SMS Marketing White Label Reseller Management system.
                            </p>
                        </div>
                    </div>
                </a>
            ...
            <div class="card-content">
                <a href="#">
                    ...
                    <div class="card-body">
                        ...
                        <div class="item-name">
                            <span>uFlowBuilder - Flow Builder Addons for SMS Marketing</span>
                            <p class="item-company">By <span class="company-name">Codeglen</span></p>
                        </div>
                        <div>
                            <p class="item-description">
            ...
            <div class="card-content">
                <a href="#">
                    ...
                    <div class="card-body">
                        ...
                        <div class="item-name">
                            <span>uAppLanding - App Landing Page for SMS Marketing</span>
                            <p class="item-company">By <span class="company-name">Codeglen</span></p>
                        </div>
                        <div>
                            <p class="item-description">
                                uAppLanding is a clean and modular App Landing Page for SMS Marketing.
                            </p>
                        </div>
                    </div>
                </a>
