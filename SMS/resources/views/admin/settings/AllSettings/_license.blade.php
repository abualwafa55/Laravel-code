<div class="col-12">
    ...
    <p>Thank you for purchasing SMS Marketing! Below is your license key, also known as Purchase Code. Your license type is <strong class="text-primary"> {{\App\Helpers\Helper::app_config('license_type')}}</strong></p>
    ...
    <p>When you purchase SMS Marketing from Envato website, you are actually purchasing a license to use the product.
